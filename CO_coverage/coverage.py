...
def run(atoms, steps, operator, calc):
    traj_out = TrajectoryWriter(f'opt_run_AgPdCO_{n_atoms}.traj')
...
no_improvements = 0
#calculator =  #OCPCalculator(checkpoint_path="/work/g15farris/ocp_pot/painn_h512_s2ef_all.pt")
...
atoms.info['data'] = {'tag': None}
atoms.info['confid'] = 1
atoms, _ = AddAdsorbate('CO', num_muts=n_atoms).get_new_individual([atoms])
